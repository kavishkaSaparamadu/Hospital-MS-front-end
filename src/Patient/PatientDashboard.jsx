...
import { TEChart } from "tw-elements-react"; // Import TEChart from the charting library
      ...
      <MainLayout data={sideNavBarLinks}>
        <div className="p-6 bg-gray-100 min-h-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* Chart Section */}
            <div className="bg-white shadow-md rounded-lg p-6">
              <h2 className="text-lg font-semibold mb-4">Traffic Chart</h2>
              {/* TEChart for the chart */}
              <TEChart
                type="bar"
                data={{
                  labels: [
